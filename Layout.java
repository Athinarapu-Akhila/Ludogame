...
public class Layout {
	...
	public void draw(Graphics2D g){
        ...
        g.drawString("Instructions:", 90,600);
        g.drawString("1.Press enter to roll the dice.", 100,650);
        g.drawString("2.If the value is 6 we have a chance to move the coin and extra chance to roll.",100, 700);
        g.drawString("3.Click on coin to move.", 100,750);
    }
}
